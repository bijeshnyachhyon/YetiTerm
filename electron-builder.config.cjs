...
module.exports = {
    ...
    mac: {
        ...
        notarize: Boolean(process.env.APPLE_ID || process.env.APPLE_API_KEY_ID || process.env.APPLE_API_KEY),
        entitlements: 'electron/entitlements.mac.plist',
        entitlementsInherit: 'electron/entitlements.mac.plist',
        extendInfo: {
            NSCameraUsageDescription: 'YetiTerm may use the camera for video calls',
            NSMicrophoneUsageDescription: 'YetiTerm may use the microphone for audio',
            NSLocalNetworkUsageDescription: 'YetiTerm needs local network access for SSH connections',
