...
const MANAGED_BLOCK_BEGIN = "# BEGIN YETITERM MANAGED - DO NOT EDIT THIS BLOCK";
const MANAGED_BLOCK_END = "# END YETITERM MANAGED";
...
const ENCODED_HOST_ALIAS_PREFIX = "yetiterm-encoded-";
...
export const mergeWithExistingSshConfig = (
  ...
  const cleanContent = existingContent.replace(
    new RegExp(
      `(?:${MANAGED_BLOCK_BEGIN.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}|${LEGACY_MANAGED_BLOCK_BEGIN.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')})[\\s\\S]*?(?:${MANAGED_BLOCK_END.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}|${LEGACY_MANAGED_BLOCK_END.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')})\\r?\\n?`,
      'g'
    ),
    ''
  );
