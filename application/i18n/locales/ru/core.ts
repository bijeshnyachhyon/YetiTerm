...
export const ruCoreMessages: Messages = {
  ...
  // App Lock
  'appLock.title': 'YetiTerm заблокирован',
  'appLock.reason.default': 'Введите пароль блокировки, чтобы продолжить.',
  'appLock.reason.startup': 'YetiTerm блокируется при каждом открытии этого окна.',
  'appLock.reason.idle': 'YetiTerm заблокирован после периода бездействия.',
  'appLock.reason.manual': 'YetiTerm был заблокирован вручную.',
  ...
  'topTabs.lockApp': 'Заблокировать YetiTerm',
  ...
  'settings.appLock.description': 'Требовать локальный пароль блокировки при открытии YetiTerm, после бездействия или при ручной блокировке.',
  ...
  'settings.appLock.enabledStatus': 'Включена. YetiTerm блокируется при запуске, после бездействия и при ручной блокировке.',
  ...
  'settings.appLock.disableDescription': 'Введите текущий пароль блокировки, чтобы YetiTerm перестал блокироваться. Сохранённый пароль будет удалён; для повторного включения нужно создать новый.',
  ...
  'settings.appLock.setupPasswordDescription': 'Этот пароль нужен для разблокировки YetiTerm, а также для изменения или отключения блокировки позже.',
  ...
  'settings.appLock.systemUnlock.desc': 'Используйте {label} как альтернативный способ разблокировать YetiTerm на этом устройстве.',
  ...
  'settings.appLock.systemUnlock.locked': 'Разблокируйте YetiTerm перед изменением системной разблокировки.',
  'settings.appLock.systemUnlock.autoPrompt.label': 'Открывать {label} автоматически',
  'settings.appLock.systemUnlock.autoPrompt.desc': 'Автоматически показывать запрос {label}, когда YetiTerm ожидает разблокировки.',
  ...
  'settings.autoLaunch.enabledDesc': 'Автоматически запускать YetiTerm при входе в систему, свернутым в системный трей.',
  ...
  'settings.update.hint': 'YetiTerm проверяет обновления через GitHub Releases.',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': 'При открытии хранилища тихо импортировать записи из OpenSSH known_hosts. Отключите, чтобы держать известные хосты YetiTerm отдельно; кнопка «Сканировать систему» по-прежнему импортирует вручную.',
...
`,
  ...
  'settings.appearance.appIcon.desc': 'Выберите стиль значка для Dock/панели задач, чтобы YetiTerm было проще найти при переключении приложений. Применяется во время работы; значок установленного пакета не меняется.',
  ...
  'settings.terminal.font.cjk.unavailableWarning': 'Этот шрифт не установлен на устройстве. YetiTerm сохранит настройку и использует безопасный запасной шрифт.',
  ...
  'settings.terminal.behavior.autoUploadClipboardImage.desc':
    'Когда в буфере обмена есть изображение, вставка в удалённой сессии загружает его по SFTP в каталог .yetiterm-paste-images/ в текущем удалённом каталоге и вводит удалённый путь вместо вставки текста.',
  ...
  'plugins.authentication.description': 'Завершите запрос аутентификации в этом диалоге YetiTerm.',
