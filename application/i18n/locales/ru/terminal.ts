...
export const ruTerminalMessages: Messages = {
  ...
  'terminal.osc7Setup.desc': 'YetiTerm добавит хуки OSC 7 для текущего удалённого пользователя. Это помогает SFTP следовать за каталогом терминала после sudo или su.',
  ...
  'cloudSync.strategy.smartMergeDesc': 'По возможности объединять изменения с обеих сторон; если YetiTerm не сможет безопасно выбрать, он попросит вас решить вручную.',
  ...
  'cloudSync.localBackups.desc': 'YetiTerm сохраняет локальные точки восстановления перед сменой версии приложения и перед восстановлением хранилища.',
  'cloudSync.localBackups.retentionTitle': 'Хранение резервных копий',
  'cloudSync.localBackups.retentionDesc': 'Выберите, сколько локальных резервных копий должен хранить YetiTerm.',
  ...
  'cloudSync.localBackups.unavailableDesc': 'Эта платформа не предоставляет YetiTerm безопасное хранилище ключей, поэтому локальные резервные копии нельзя записывать безопасно. Установите YetiTerm в систему с поддерживаемым keychain, чтобы включить историю локальных резервных копий.',
  ...
  'cloudSync.githubFlow.desc': 'Скопируйте код ниже и введите его на GitHub, чтобы авторизовать YetiTerm.',
  ...
  'snippets.import.toast.invalidDesc': 'Это невалидный файл сниппетов YetiTerm.',
  ...
  'snippets.import.modal.desc': 'Выберите один или несколько JSON-файлов сниппетов YetiTerm. YetiTerm сначала покажет результат разбора и ничего не импортирует без подтверждения.',
