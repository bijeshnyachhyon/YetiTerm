...
export const enAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': 'Leave blank to use the model list value when available, otherwise YetiTerm uses a safe default.',
  ...
  'ai.codex.customConfigMissingEnvKey': 'Warning: {envKey} is not set in your shell environment. Export it (or launch yetiterm from a shell that has it) so Codex can authenticate.',
  ...
  'ai.cursor.apiKeyEnvHint': 'Cursor can use CURSOR_API_KEY from your shell. Save a key here only if you want YetiTerm to override it.',
  'ai.cursor.apiKeyOverrideHint': 'YetiTerm will use the saved key here before CURSOR_API_KEY.',
  ...
  'ai.codebuddy.persistSession.hint': "Keep CodeBuddy's own session transcript on disk so CodeBuddy can resume it later. Turn off to disable CodeBuddy session storage; YetiTerm may still save chat history and external session metadata. File checkpointing is skipped. Requires CodeBuddy CLI 2.125.1 or newer.",
  ...
  'ai.grok.runtime.acp.description':
    'Talk to Grok over Agent Client Protocol (grok agent stdio). Injects YetiTerm MCP on session/new. Turn off to use the original headless streaming-json CLI path.',
  ...
  'ai.toolAccess.mode': 'YetiTerm Access Mode',
  'ai.toolAccess.description': 'Choose how external agents access YetiTerm sessions. MCP exposes the built-in server, while Skills + CLI points agents to the local YetiTerm skill and CLI commands.',
  'ai.toolAccess.mode.mcp': 'MCP',
  'ai.toolAccess.mode.skills': 'Skills + CLI',
  'ai.toolAccess.mcpPrompt.title': 'Prompt for your AI client',
  'ai.toolAccess.mcpPrompt.description': 'Paste this prompt into your AI client (Codex, Claude Code, …) and it will register YetiTerm MCP for you.',
  ...
  'ai.toolAccess.skills.description': 'In Skills + CLI mode, agents are pointed to this local skill file automatically. The YetiTerm CLI launcher path is provided to the agent in each session.',
  ...
  'ai.externalMcp.description': 'Expose YetiTerm as an MCP server for external clients such as Codex, Claude Code, Cursor, and Grok. Uses the same catalog tools as in-app agents (terminal, SFTP, Vault, port forwarding). Keep YetiTerm running while clients are connected.',
  ...
  'ai.externalMcp.mode.description': 'Temporary mode auto-disables after idle timeout. Always-on restores External MCP when YetiTerm starts.',
  ...
  'ai.externalMcp.usage.keepRunning': '1. Turn on External MCP and keep YetiTerm running.',
  ...
  'ai.externalMcp.permissionMode.hint': 'Same setting as Settings → AI → Safety. Auto runs YetiTerm write tools without YetiTerm approval prompts; Confirm asks each time. External clients (Codex / Claude / Grok) may still show their own tool approval UI.',
  ...
  'ai.externalMcp.codexAdded': 'Codex MCP entry and YetiTerm skill added. Restart Codex or open a new Codex session.',
  'ai.externalMcp.claudeAdded': 'Claude Code MCP entry and YetiTerm skill added. Restart Claude Code or open a new Claude Code session.',
  'ai.externalMcp.grokAdded': 'Grok MCP entry and YetiTerm skill added. Restart Grok or open a new Grok session.',
  ...
  'ai.externalMcp.conflict.description': 'A yetiterm-external entry already exists and points elsewhere. Remove or edit it manually.',
  ...
  'ai.userSkills.description': 'Open the YetiTerm skills folder to add your own skill directories. YetiTerm scans these skills automatically and injects only lightweight indexes unless a skill clearly matches the current request.',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Codex main-process handlers are not loaded yet. Fully restart YetiTerm, or restart the Electron dev process, then try again.',
  ...
  'ai.safety.permissionMode.description': 'Controls how the AI interacts with your YetiTerm terminal sessions. Observer mode blocks write operations that go through YetiTerm. External agent CLIs may still have their own local tools and approval flow.',
  ...
  'ai.safety.commandTimeout.description': 'Maximum seconds a command can run before being terminated through YetiTerm execution.',
  ...
  'ai.safety.blocklist.description': 'Regex patterns to block dangerous commands executed through YetiTerm.',
  ...
  'ai.safety.note': 'These safety settings are enforced for actions that go through YetiTerm. External agent CLIs may also expose local tools that are governed by the agent itself.',
