...
export const enVaultMessages: Messages = {
  ...
  'pf.type.dynamic.desc': 'Dynamic port forwarding turns YetiTerm into a SOCKS proxy server.',
  ...
  'settings.sshDeepLink.enable': 'Open ssh:// and telnet:// links with YetiTerm',
  'settings.sshDeepLink.enableDesc': 'Allow YetiTerm to handle ssh:// and telnet:// links from browsers and other apps, plus PuTTY-style launches such as -ssh user@host -P 22 -pw password.',
  'settings.explorerContextMenu.title': 'Windows Explorer',
  'settings.explorerContextMenu.enable': 'Show “Open in YetiTerm” in folder context menus',
  ...
  'settings.jmsDeepLink.enableDesc': 'Register YetiTerm as the handler for JumpServer jms:// client links. May conflict with the official JumpServer client.',
  ...
  'hostDetails.algorithms.inheritedNotice': 'The current group has algorithm overrides set for: {categories}. The "Reset" button here falls back to the group\'s lists, not YetiTerm\'s defaults. To ignore the group restriction, clear the override in the group\'s algorithm settings.',
