...
export const enCoreMessages: Messages = {
  ...
  // App Lock
  'appLock.title': 'YetiTerm is locked',
  'appLock.reason.default': 'Enter your lock password to continue.',
  'appLock.reason.startup': 'YetiTerm locks each time this window opens.',
  'appLock.reason.idle': 'YetiTerm locked after the inactivity timeout.',
  'appLock.reason.manual': 'YetiTerm was locked manually.',
  ...
  'settings.appLock.description': 'Require a local lock password when YetiTerm opens, after inactivity, or when you lock it manually.',
  ...
  'settings.appLock.enabledStatus': 'Enabled. YetiTerm locks on startup, after inactivity, and when you lock it manually.',
  ...
  'settings.appLock.disableDescription': 'Enter the current lock password to stop locking YetiTerm. The saved password will be removed; turning App Lock on again requires creating a new one.',
  ...
  'settings.appLock.setupPasswordDescription': 'This password is required to unlock YetiTerm and to change or turn off App Lock later.',
  ...
  'settings.appLock.systemUnlock.desc': 'Use {label} as an alternate way to unlock YetiTerm on this device.',
  ...
  'settings.appLock.systemUnlock.locked': 'Unlock YetiTerm before changing system unlock.',
  'settings.appLock.systemUnlock.autoPrompt.label': 'Open {label} automatically',
  'settings.appLock.systemUnlock.autoPrompt.desc': 'Show the {label} prompt automatically when YetiTerm is waiting to unlock.',
  ...
  'settings.autoLaunch.enabledDesc': 'Automatically start YetiTerm when you log in, hidden in the system tray.',
  ...
  'settings.update.hint': 'YetiTerm checks for updates from GitHub Releases.',
  ...
  'settings.sessionRestore.startupLandingDesc': 'Choose whether to open the host home page or a local terminal when YetiTerm starts with no restored sessions.',
  ...
  'settings.vault.autoImportSystemKnownHostsDesc': 'When Vault loads, silently import entries from the OpenSSH known_hosts file. Turn this off to keep YetiTerm known hosts separate; Scan System still imports on demand.',
...
`,
  ...
  'settings.appearance.appIcon.desc': 'Choose a dock/taskbar icon style to make YetiTerm easier to spot when switching apps. Applies at runtime; the installed app bundle icon is unchanged.',
  ...
  'settings.terminal.font.cjk.unavailableWarning': 'This font is not installed on this device. YetiTerm will keep the setting and use a safe fallback.',
  ...
  'plugins.authentication.description': 'Complete the authentication request in this YetiTerm dialog.',
