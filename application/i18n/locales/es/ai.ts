...
export const esAiMessages: Messages = {
  ...
  'ai.providers.contextWindow.help': 'Déjalo en blanco para usar el valor de la lista de modelos cuando esté disponible; de lo contrario, YetiTerm usa un valor predeterminado seguro.',
  ...
  'ai.codex.customConfigMissingEnvKey': 'Advertencia: {envKey} no está definida en tu entorno de shell. Expórtala (o inicia yetiterm desde un shell que la tenga) para que Codex pueda autenticarse.',
  ...
  'ai.cursor.apiKeyEnvHint': 'Cursor puede usar CURSOR_API_KEY de tu shell. Guarda una clave aquí solo si quieres que YetiTerm la anule.',
  'ai.cursor.apiKeyOverrideHint': 'YetiTerm usará la clave guardada aquí antes que CURSOR_API_KEY.',
  ...
  'ai.grok.runtime.acp.description':
    'Habla con Grok mediante el Protocolo de Cliente de Agente (grok agent stdio). Inyecta el MCP de YetiTerm en session/new. Apágalo para usar la ruta original de CLI headless con streaming-json.',
  ...
  'ai.toolAccess.mode': 'Modo de acceso de YetiTerm',
  'ai.toolAccess.description': 'Elige cómo acceden los agentes externos a las sesiones de YetiTerm. MCP expone el servidor integrado, mientras que Habilidades + CLI apunta a los agentes hacia las habilidades locales de YetiTerm y los comandos de CLI.',
  ...
  'ai.toolAccess.mcpPrompt.description': 'Pega este prompt en tu cliente de IA (Codex, Claude Code, …) y registrará el MCP de YetiTerm por ti.',
  ...
  'ai.toolAccess.skills.description': 'En modo Habilidades + CLI, los agentes apuntan automáticamente a este archivo de skill local. La ruta del lanzador de la CLI de YetiTerm se entrega al agente en cada sesión.',
  ...
  'ai.externalMcp.description': 'Expón YetiTerm como un servidor MCP para clientes externos como Codex, Claude Code, Cursor y Grok. Usa las mismas herramientas del catálogo que los agentes de la aplicación (terminal, SFTP, Vault, reenvío de puertos). Mantén YetiTerm en ejecución mientras los clientes estén conectados.',
  ...
  'ai.externalMcp.mode.description': 'El modo temporal se desactiva automáticamente tras el tiempo de inactividad. El modo Siempre activo restaura el MCP externo cuando se inicia YetiTerm.',
  ...
  'ai.externalMcp.usage.keepRunning': '1. Activa el MCP externo y mantén YetiTerm en ejecución.',
  ...
  'ai.externalMcp.permissionMode.hint': 'La misma configuración que Configuración → IA → Seguridad. Automático ejecuta las herramientas de escritura de YetiTerm sin solicitar aprobación de YetiTerm; Confirmar pregunta cada vez. Los clientes externos (Codex / Claude / Grok) aún pueden mostrar su propia interfaz de aprobación de herramientas.',
  ...
  'ai.externalMcp.codexAdded': 'Entrada MCP de Codex y skill de YetiTerm agregados. Reinicia Codex o abre una nueva sesión de Codex.',
  'ai.externalMcp.claudeAdded': 'Entrada MCP de Claude Code y skill de YetiTerm agregados. Reinicia Claude Code o abre una nueva sesión de Claude Code.',
  'ai.externalMcp.grokAdded': 'Entrada MCP de Grok y skill de YetiTerm agregados. Reinicia Grok o abre una nueva sesión de Grok.',
  ...
  'ai.externalMcp.conflict.description': 'Ya existe una entrada yetiterm-external que apunta a otro lugar. Quítala o edítala manualmente.',
  ...
  'ai.userSkills.description': 'Abre la carpeta de habilidades de YetiTerm para agregar tus propios directorios de habilidades. YetiTerm escanea estas habilidades automáticamente e inyecta solo índices ligeros, salvo que una habilidad coincida claramente con la petición actual.',
  ...
  // AI Error
  'ai.codex.bridgeError': 'Los controladores del proceso principal de Codex aún no están cargados. Reinicia YetiTerm por completo o reinicia el proceso de desarrollo de Electron y vuelve a intentarlo.',
  ...
  'ai.safety.permissionMode.description': 'Controla cómo interactúa la IA con tus sesiones de terminal de YetiTerm. El modo Observador bloquea las operaciones de escritura que pasan por YetiTerm. Las CLIs de agentes externos pueden seguir teniendo sus propias herramientas locales y flujo de aprobación.',
  ...
  'ai.safety.commandTimeout.description': 'Máximo de segundos que un comando puede ejecutarse antes de ser terminado mediante la ejecución de YetiTerm.',
  ...
  'ai.safety.blocklist.description': 'Patrones regex para bloquear comandos peligrosos ejecutados mediante YetiTerm.',
  ...
  'ai.safety.note': 'Estos ajustes de seguridad se aplican a las acciones que pasan por YetiTerm. Las CLIs de agentes externos también pueden exponer herramientas locales regidas por el propio agente.',
