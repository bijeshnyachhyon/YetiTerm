...
export const NETCATTY_MONACO_THEME_DARK = 'yetiterm-dark';
export const NETCATTY_MONACO_THEME_LIGHT = 'yetiterm-light';
export const YETITERM_MONACO_THEME_DARK = 'yetiterm-dark';
export const YETITERM_MONACO_THEME_LIGHT = 'yetiterm-light';

export const getYetiTermMonacoThemeName = (isDark: boolean): string => (
  isDark ? YETITERM_MONACO_THEME_DARK : YETITERM_MONACO_THEME_LIGHT
);
export const getNetcattyMonacoThemeName = getYetiTermMonacoThemeName;
