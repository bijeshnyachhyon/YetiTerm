...
function resolveTrayIconPath() {
  ...
  //  - macOS: logo1.png / tray-icon.png (colored or template)
  ...
  if (process.platform === "darwin") {
    iconNames = ["logo1.png", "tray-icon.png", "tray-iconTemplate.png"];
  } else if (process.platform === "win32") {
    iconNames = ["tray-icon.ico", "logo1.png", "tray-icon.png"];
  } else {
    iconNames = ["logo1.png", "tray-icon.png"];
  }
  ...
  try {
    ...
    if (resolvedIconPath) {
      ...
      if (process.platform === "darwin") {
        ...
        const isTemplate = resolvedIconPath.includes("Template");
        if (typeof trayIcon.setTemplateImage === "function") {
          trayIcon.setTemplateImage(isTemplate);
        }
      } else if (process.platform === "win32") {
